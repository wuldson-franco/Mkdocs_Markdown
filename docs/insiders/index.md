...
<figure class="mdx-video" markdown>
  <div class="mdx-video__inner">
    <iframe src="https://www.youtube.com/embed/QfilLP9VLoc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
  <figcaption markdown>
...
- [x] [Header hides on scroll]
  ...
  [Navigation sections]: ../projetos/setting-up-navigation.md#navigation-sections
  [Navigation expansion]: ../projetos/setting-up-navigation.md#navigation-expansion
  [Hiding the sidebars]: ../projetos/setting-up-navigation.md#hiding-the-sidebars
  [Table of contents in navigation]: ../projetos/setting-up-navigation.md#navigation-integration
  [Header hides on scroll]: ../projetos/setting-up-the-header.md#automatic-hiding
...
See the [Sistemas guide] for more information.

  [configuration inheritance]: https://www.mkdocs.org/user-guide/configuration/#configuration-inheritance
  [Sistemas guide]: sistemas.md#caveats
